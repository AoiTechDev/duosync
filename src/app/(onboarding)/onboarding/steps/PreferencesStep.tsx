...
export default function PreferencesStep() {
  ...
  const isValid = preferences.mainRole && preferences.goals.length > 0 && 
      ...
      {errors.length > 0 && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex items-start gap-2">
            ...
            <div>
              <h4 className="font-medium text-red-900 mb-1">Please complete the following:</h4>
       ...
       <div className="space-y-3">
         ...
         <div className="flex flex-wrap gap-2">
           <TagButton
             ...
             label="No preference"
           />
           {ROLES.filter(role => role.id !== preferences.mainRole).map((role) => (
             <TagButton
               key={role.id}
       ...
       <div className="space-y-3">
         ...
         <div className="flex flex-wrap gap-2">
           {PLAYSTYLE_TAGS.map((tag) => {
             ...
             const isDisabled = !isSelected && preferences.playstyleTags.length >= 8;
             ...
             return (
               <TagButton
                 ...
                 selected={isSelected}
                 disabled={isDisabled}
                 onClick={() => !isDisabled && toggleArrayPreference('playstyleTags', tag.id)}
                 icon={tag.icon}
                 label={tag.name}
               />
             );
